...
typedef struct {
	...
	int (*expand_message_finalize_48B)(void *ctx, uint8_t out[48], const uint8_t *dst, uint8_t dst_len);
	int (*expand_message_dyn)(void *ctx, uint8_t *out, uint32_t out_len, const uint8_t *msg, uint32_t msg_lg, const uint8_t *dst, uint8_t dst_len);
