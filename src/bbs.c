...
#define BBS_CIPHER_ID       "BBS_BLS12381G1_XMD:SHA-256_SSWU_RO_"
#define BBS_SHA_256_DEFAULT_KEY_DST BBS_CIPHER_ID "KEYGEN_DST_"
#define BBS_SHA_256_API_ID          BBS_CIPHER_ID "H2G_HM2S_"
